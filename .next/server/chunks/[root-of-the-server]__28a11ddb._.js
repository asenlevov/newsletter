...
"[externals]/node:assert [external] (node:assert, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:querystring [external] (node:querystring, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:diagnostics_channel [external] (node:diagnostics_channel, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:tls [external] (node:tls, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:util/types [external] (node:util/types, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:worker_threads [external] (node:worker_threads, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:http2 [external] (node:http2, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:console [external] (node:console, cjs)": ((__turbopack_context__) => {
...
"[externals]/node:dns [external] (node:dns, cjs)": ((__turbopack_context__) => {
...
async function processURL(url) {
    const textContent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gemini$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchAndParseURL"])(url);
    if (!textContent) {
        return {
            url,
  ...
  `;
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gemini$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gemini"].generateContent(prompt);
...
async function POST(request) {
    ...
    `;
        ...
        const templatePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'newsletter_template.html');
        ...
        template = template.replace('<!-- COUNTERS_USERS_CONTENT -->', `<h2 style="font-size: 28px; font-weight: bold; color: #004aad;">${body.counters.users}</h2>`);
        template = template.replace('<!-- COUNTERS_INTERVIEWS_CONTENT -->', `<h2 style="font-size: 28px; font-weight: bold; color: #004aad;">${body.counters.interviews}</h2>`);
        template = template.replace('<!-- COUNTERS_HOURS_CONTENT -->', `<h2 style="font-size: 28px; font-weight: bold; color: #004aad;">${body.counters.hours}</h2>`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__28a11ddb._.js.map